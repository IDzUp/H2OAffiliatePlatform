...
spl_autoload_register(function($sClass)
{
    ...
    /*** For Kernel module ***/
    if (is_file(H2O_SERVER_PATH . 'app/modules/kernel/classes' . $sClass . '.php'))
        require_once H2O_SERVER_PATH . 'app/modules/kernel/classes' . $sClass . '.php';

    if (is_file(H2O_SERVER_PATH . 'app/modules/kernel/models' . $sClass . '.php'))
        require_once H2O_SERVER_PATH . 'app/modules/kernel/models' . $sClass . '.php';

    if (is_file(H2O_SERVER_PATH . 'app/modules/kernel/forms' . $sClass . '.php'))
        require_once H2O_SERVER_PATH . 'app/modules/kernel/forms' . $sClass . '.php';

    if (is_file(H2O_SERVER_PATH . 'app/modules/kernel/forms/process' . $sClass . '.php'))
        require_once H2O_SERVER_PATH . 'app/modules/kernel/forms/process' . $sClass . '.php';
